...
| T-015 | 手机真实输出成功日志 | done | T-010A；手机 SSH | Codex | 成功显示 state/preset；重复心跳不刷屏；失败不报成功、恢复可见；3 项对应测试和 check 通过；receiver-et6Qrz 已更新，手机真实五态、三次心跳去重、超时及恢复通过；证据 docs/evidence/T-015.md |
